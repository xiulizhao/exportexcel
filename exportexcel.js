(function(root, factory) {
   ...
   */
  function expor_excel($ele){
    var fileName = $ele.attr("data-filename") || "表格";
    var excelID = $ele.attr("data-excelid");
    var btnID = $ele.attr("data-btnid") || "btnID";
    $ele.find(".btn").attr("id", btnID);
    ...
    $ele.find("#" + btnID).on("click",function () {
      tableToExcel(document.getElementById(excelID), "name", fileName + ".xls");
    });
  }
